    ...
    <section id="details-section" className="relative py-14 md:py-16 px-4" style={{ background: "var(--gradient-sage)" }}>
      ...
      >
        ...
        <motion.div variants={itemVariants} className="mb-8 md:mb-10 text-center">
          ...
          <div className="inline-flex items-center gap-3 rounded-full bg-white/50 px-4 py-2 text-xl md:text-xl shadow-sm ring-3 ring-white/10 backdrop-blur font-bold">
                ...
                <div className="flex-1">
                  ...
                  <div className="mt-4 flex gap-2 flex-wrap">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-2 rounded-full bg-[#B3E6FC] px-4 py-2 text-sm text-black shadow-sm transition-all hover:scale-105 hover:shadow-lg"
                    >
